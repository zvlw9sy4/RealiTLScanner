...
func main() {
	...
	// Changed default output filename to include timestamp would be nice, but keeping it simple
	flag.StringVar(&out, "out", "results.csv", "Output file to store the result")
